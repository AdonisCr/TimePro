...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-bg-light to-blue-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-text-gray">
            Connectez-vous à votre compte Time Pro
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-text-gray">
                  Se souvenir de moi
                </label>
              </div>
            ...
            <button
              type="submit"
              className="w-full bg-primary hover:bg-primary-hover text-white py-3 px-4 rounded-lg font-semibold text-lg transition-all hover:shadow-lg hover:scale-105"
            >
              Se connecter
            </button>
          </form>
          ...
          <div className="my-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-text-gray">Ou continuer avec</span>
              </div>
            </div>
          </div>
